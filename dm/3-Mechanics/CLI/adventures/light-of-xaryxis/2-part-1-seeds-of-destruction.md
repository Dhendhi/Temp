...
The mess hall contains a [neh-thalggu](3-Mechanics/CLI/bestiary/aberration/neh-thalggu-bam.md) (see "Boo's Astral Menagerie") that currently has eight brains. The neh-thalggu, kept as a pet by the mind flayers, evaded the githyanki by using its [invisibility](3-Mechanics/CLI/spells/invisibility.md) spell, but it was later trapped here by the human pirates after it killed one of their number.
