...
| 2 | You gain `d3` levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). Until the curse ends, these levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) can't be removed. |
...
| 6 | Moonlight burns your flesh. You take `d10` radiant damage when you start your turn in moonlight. |
...
| 8 | Whenever you tell a lie, you lose the ability to speak for `d8` hours. |
^fey-curses