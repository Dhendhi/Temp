...
| 10 | Magic goes awry, creating random zones of wild magic (where casting any spell of 1st level or higher causes a roll on the [Wild Magic Surge table](3-Mechanics/CLI/tables/wild-magic-surge-phb.md) in the "Player's Handbook") and dead magic (like an [Antimagic Field](3-Mechanics/CLI/spells/antimagic-field.md) spell on a larger scale). |
