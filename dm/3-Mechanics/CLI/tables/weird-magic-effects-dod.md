...
| 8 | One character in the region triggers a wild magic effect that is determined by rolling on the [Wild Magic Surge](3-Mechanics/CLI/tables/wild-magic-surge-phb.md) table in the "Sorcerer" section of the Player's Handbook. If the effect duplicates a spell, the character's spellcasting ability for that spell is Charisma. |
^weird-magic-effects