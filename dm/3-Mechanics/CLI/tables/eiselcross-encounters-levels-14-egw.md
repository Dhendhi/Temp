...
| dice: d6 | Encounter |
|----------|-----------|
| 1 | The characters encounter `d4` wildfolk [scouts](3-Mechanics/CLI/bestiary/humanoid/scout.md) hunting a [saber-toothed tiger](3-Mechanics/CLI/bestiary/beast/saber-toothed-tiger.md). The scouts are out of arrows and willing to trade equipment and information to replenish their ammunition. |
| 2 | The characters encounter a lost Cerberus Assembly [mage](3-Mechanics/CLI/bestiary/humanoid/mage.md) trying to return to Balenpost. The rest of the mage's team died in the ruins of Aeor, and there is a 50 percent chance the mage carries a recently recovered Aeorian item. |
...
| 5 | The characters find a 3-foot-tall, 50-pound egg. If they keep the egg in a cold environment for `d10` weeks, a [white dragon wyrmling](3-Mechanics/CLI/bestiary/dragon/white-dragon-wyrmling.md) hatches from it. |
