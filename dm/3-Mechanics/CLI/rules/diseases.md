...
Symptoms manifest `d4` hours after infection and include fever and disorientation. The infected creature gains one level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) that can't be removed until the disease is cured.
