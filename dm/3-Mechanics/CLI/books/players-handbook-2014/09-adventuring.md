...
At the end of a fall, a creature takes `d6` bludgeoning damage for every 10 feet it fell, to a maximum of `20d6`. The creature lands [prone](3-Mechanics/CLI/rules/conditions.md#Prone), unless it avoids taking damage from the fall.
