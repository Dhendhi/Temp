...
![Fruit Stalls; Fey Fruit Effects](3-Mechanics/CLI/tables/fruit-stalls-fey-fruit-effects-bmt.md)
...
Clawson has ten items from the [Trinkets table](3-Mechanics/CLI/items/trinket.md) of the "Player's Handbook" for sale. He also has `d4` items he markets as "today's secondhand steal," highlighting them to any visitors. You can determine these items by rolling on or choosing from the Secondhand Steals table.

> [!embed-item]- Secondhand Steal Trinket
> ![Secondhand Steal Trinket](3-Mechanics/CLI/items/secondhand-steal-trinket-bmt.md)
...
![Fortune-Telling; Fortunes](3-Mechanics/CLI/tables/fortune-telling-fortunes-bmt.md)
