...
- **Brink of Death.** Creatures within the Gardens of Decay have disadvantage on death saving throws. If a Humanoid dies within the gardens, it rises as a [shadow](3-Mechanics/CLI/bestiary/undead/shadow.md) in the Glass Arboretum in `d4` days unless it is raised from the dead before then. A creature turned into a shadow in this way can't be returned to life by any means.  
