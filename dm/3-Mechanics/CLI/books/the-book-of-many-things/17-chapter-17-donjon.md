...
![Mark of the Donjon; Marks of the Donjon](3-Mechanics/CLI/tables/mark-of-the-donjon-marks-of-the-donjon-bmt.md)
...
If two gems are removed, the power core at the heart of the Donjon Sphere implodes after `2d8` hours. This is reduced to `d4` hours if three gems are removed, and to just `d4` minutes if all four gems are removed. Replacing all four gems before the power core implodes resets the time limit.
