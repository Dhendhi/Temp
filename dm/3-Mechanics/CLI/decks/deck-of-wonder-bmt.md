...
### Chancellor
![](3-Mechanics/CLI/decks/img/deck-of-wonder-01-chancellor.webp#card)
...
### Day
![](3-Mechanics/CLI/decks/img/deck-of-wonder-02-day.webp#card)
You gain a +1 bonus to saving throws. This benefit lasts until you finish a long rest.

### Night
![](3-Mechanics/CLI/decks/img/deck-of-wonder-03-night.webp#card)
...
### Dawn
![](3-Mechanics/CLI/decks/img/deck-of-wonder-04-dawn.webp#card)
This card invigorates you. For the next 8 hours, you can add your proficiency bonus to your initiative rolls.

### Dusk
![](3-Mechanics/CLI/decks/img/deck-of-wonder-05-dusk.webp#card)
...
### Destiny
![](3-Mechanics/CLI/decks/img/deck-of-wonder-06-destiny.webp#card)
...
### Crown
![](3-Mechanics/CLI/decks/img/deck-of-wonder-07-crown.webp#card)
...
### Lock
![](3-Mechanics/CLI/decks/img/deck-of-wonder-08-lock.webp#card)
You gain the ability to cast [Knock](3-Mechanics/CLI/spells/knock.md) `d3` times. Use your Intelligence, Wisdom, or Charisma as the spellcasting ability (your choice).

### Champion
![](3-Mechanics/CLI/decks/img/deck-of-wonder-09-champion.webp#card)
You gain a +1 bonus to weapon attack and damage rolls. This bonus lasts for 8 hours.

### Coin
![](3-Mechanics/CLI/decks/img/deck-of-wonder-10-coin.webp#card)
Five pieces of jewelry, each worth 100 gp, or ten gemstones, each worth 50 gp, appear at your feet.

### Vulture
![](3-Mechanics/CLI/decks/img/deck-of-wonder-11-vulture.webp#card)
...
### Chaos
![](3-Mechanics/CLI/decks/img/deck-of-wonder-12-chaos.webp#card)
You gain resistance to one of the following damage types (chosen by the DM): acid, cold, fire, lightning, or thunder. This resistance lasts for `d12` days.

### Order
![](3-Mechanics/CLI/decks/img/deck-of-wonder-13-order.webp#card)
You gain resistance to one of the following damage types (chosen by the DM): force, necrotic, poison, psychic, or radiant. This resistance lasts for `d12` days.

### Beginning
![](3-Mechanics/CLI/decks/img/deck-of-wonder-14-beginning.webp#card)
...
### Mystery
![](3-Mechanics/CLI/decks/img/deck-of-wonder-15-mystery.webp#card)
...
### Isolation
![](3-Mechanics/CLI/decks/img/deck-of-wonder-16-isolation.webp#card)
You disappear, along with anything you are wearing or carrying, and become trapped in a harmless extradimensional space for `d4` minutes. You draw no more cards. You then reappear in the space you left or the nearest unoccupied space. When you reappear, you must succeed on a DC 11 Constitution saving throw or have the poisoned condition for 1 hour as your body reels from the extradimensional travel.

### End
![](3-Mechanics/CLI/decks/img/deck-of-wonder-17-end.webp#card)
...
### Monster
![](3-Mechanics/CLI/decks/img/deck-of-wonder-18-monster.webp#card)
This card's monstrous visage curses you. While cursed in this way, whenever you make a saving throw, you must roll `d4` and subtract the number rolled from the total. The curse lasts until you finish a long rest, but it can be ended early with a [Remove Curse](3-Mechanics/CLI/spells/remove-curse.md) spell or similar magic.

### Knife
![](3-Mechanics/CLI/decks/img/deck-of-wonder-19-knife.webp#card)
An uncommon magic weapon you're proficient with appears in your hands. The DM chooses the weapon.

### Justice
![](3-Mechanics/CLI/decks/img/deck-of-wonder-20-justice.webp#card)
...
### Student
![](3-Mechanics/CLI/decks/img/deck-of-wonder-21-student.webp#card)
...
### Mischief
![](3-Mechanics/CLI/decks/img/deck-of-wonder-22-mischief.webp#card)
