...
You gain the ability to cast the [Time Stop](3-Mechanics/CLI/spells/time-stop.md) spell `d3` times. Use your Intelligence, Wisdom, or Charisma as the spellcasting ability (your choice).
...
Roll a `d20`. If the roll is even, you age `d10` years. If the roll is odd, you become younger by `d10` years, to a minimum of 1 year. This effect can be undone only by the [Wish](3-Mechanics/CLI/spells/wish.md) spell, divine intervention, or similar magic.
...
You gain the ability to cast the [Gate](3-Mechanics/CLI/spells/gate.md) spell `d4` times, requiring no material components. Use your Intelligence, Wisdom, or Charisma as the spellcasting ability (your choice).
...
You gain `d3` levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion).

### Mine
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-34-mine.webp#card)
A pile of `2d6` gems (each worth 5,000 gp) and `d10` chunks of precious ore (each worth 2,500 gp) appears at your feet.
...
You are granted the ability to cast the [wish](3-Mechanics/CLI/spells/wish.md) spell `d3` times.
